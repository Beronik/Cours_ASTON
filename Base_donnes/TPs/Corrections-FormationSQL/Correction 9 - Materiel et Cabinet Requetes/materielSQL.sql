...
CREATE TABLE IF NOT EXISTS `materiel`.`CLIENT` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_CLIENT_ADRESSE1_idx` (`ADRESSE_id` ASC),
...
CREATE TABLE IF NOT EXISTS `materiel`.`FICHE_LOCATION` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_FICHE_LOCATION_CLIENT1_idx` (`CLIENT_id` ASC),
...
CREATE TABLE IF NOT EXISTS `materiel`.`FICHE_LOCATION_CONCERNE_MATERIEL` (
  ...
  `dateFin` DATE NULL COMMENT 'Date de retour reel du materiel',
  PRIMARY KEY (`FICHE_LOCATION_id`, `MATERIEL_id`),
  INDEX `fk_FICHE_LOCATION_has_MATERIEL_MATERIEL1_idx` (`MATERIEL_id` ASC),
  INDEX `fk_FICHE_LOCATION_has_MATERIEL_FICHE_LOCATION1_idx` (`FICHE_LOCATION_id` ASC),
